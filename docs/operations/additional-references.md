# Ergaenzende Betriebsreferenzen
...
SHA-256-Pruefwert zu. Die zugehoerige Datei heisst `<Referenz-ID>.md`.
Die Originale wurden vor dem Ersetzen der lokalen Verweise vollstaendig kopiert
und anhand dieses Pruefwerts verifiziert. Sie sind historische Befunde, keine
Zusicherung ueber den aktuellen Dienstzustand.

Das Archiv ist fuer den Betreiber bestimmt und wird nicht in normale
App-/Partner-Sessions oder die allgemeine Wissenssuche geladen.
