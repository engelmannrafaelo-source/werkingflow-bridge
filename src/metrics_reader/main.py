    ...
    for worker in BRIDGE_WORKERS:
        ...
        try:
            ...
            accounts[account] = {
                ...
                "predictive_throttle_enabled": data.get("predictive_throttle_enabled", False),
                "budget_multiplier": data.get("budget_multiplier", 1.0),
                "effective_cap_tokens": data.get("effective_cap_tokens", 0),
